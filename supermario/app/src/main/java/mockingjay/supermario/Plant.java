...
public class Plant extends MovingObject {
    ...
    public void draw(Canvas canvas, Bitmap plantIcon, Rect plantRect){
        plantRect.set(xTop, yTop, xBot, yBot);
        canvas.drawBitmap(plantIcon, null, plantRect, null);
